...
// console.log(resolve('foo/bar', '/tmp/file/', '..', 'a/../subfile')) // /temp/subfile
// console.log(resolve('/foo/bar', './baz')); // /foo/bar/baz
// console.log(resolve('/foo/bar', '/tmp/file/')); // 'tmp/file'
// console.log(resolve('wwwroot', 'static_files/png/', '../gif/image.gif')); // 当前目录下的 /wwwroot/static_files/gif/image.gif